    ...
    <div class="text-center p-4 p-md-5">
        ...
        <div class="mb-4 d-flex flex-column align-items-center justify-content-center">
            <div class="position-relative d-inline-block">
                <i class="bi bi-hourglass-split" style="font-size: 6rem; color: #004AAD !important;"></i>
        ...
        <p style="font-size: 1.125rem; font-weight: 400; color: #64748B; line-height: 1.6; max-width: 500px;" class="mx-auto mb-5">
            Your session has timed out while waiting in the lobby. For your security, please refresh the page to continue your booking.
        </p>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
            <button onclick="window.location.reload()" 
                ...
                <i class="bi bi-arrow-clockwise me-2"></i>Refresh Session
            </button>
        ...
        <div class="mt-5 pt-4 border-top" style="border-color: #E2E8F0 !important;">
            <p style="font-size: 12px; font-weight: 400; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.05em;">
                Session Timeout • Security Token Expired • Abreeza Cinema Hub
            </p>
        </div>
    </div>
</div>
...
<style>
    ...
    .btn:hover { 
        ...
        box-shadow: 0 4px 12px rgba(0, 74, 173, 0.15) !important;
    }
</style>
@endsection