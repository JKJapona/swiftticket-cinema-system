<div class="toast-container-custom position-fixed top-0 end-0 p-3" style="z-index: 10050;">
    ...
    @if(session('success'))
        <div class="alert alert-dismissible fade show shadow-sm border-0 mb-2 p-3" role="alert" 
             style="background: white; border: 1px solid #e2e8f0 !important; border-left: 4px solid #10b981 !important; min-width: 300px; border-radius: 8px;">
    ...
    @if(session('error'))
        <div class="alert alert-dismissible fade show shadow-sm border-0 mb-2 p-3" role="alert" 
             style="background: white; border: 1px solid #fecaca !important; border-left: 4px solid #ef4444 !important; min-width: 300px; border-radius: 8px;">
            <div class="d-flex align-items-start">
                <div class="flex-shrink-0 me-3">
