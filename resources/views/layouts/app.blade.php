        ...
        @else
            <div class="d-flex align-items-center justify-content-between w-100">
                ...
                <div class="d-flex align-items-center gap-4">
                    @auth
                        <a href="{{ route('bookings.my-bookings') }}" class="nav-link-custom d-flex align-items-center gap-2 small fw-medium text-decoration-none text-dark">
                        ...
                        <div class="dropdown">
                            <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-slate-900 dropdown-toggle" data-bs-toggle="dropdown">
                                <div class="user-avatar bg-light border rounded-circle d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mt-2 border-0 shadow p-2">
                                ...
                                <li><a class="dropdown-item rounded-2" href="#"><i class="bi bi-person me-2"></i>Profile</a></li>
                                <li><hr class="dropdown-divider opacity-50"></li>
                                <li>
