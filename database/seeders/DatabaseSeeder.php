...
class DatabaseSeeder extends Seeder
{
    ...
    [
        ...
        'runtime_minutes' => 115,
        'rating' => 'R-13',
        'poster_path' => 'https://m.media-amazon.com/images/M/MV5BNjFiZjk0NDItNjJiMy00YTc3LWI0OWQtMjBlNWQxYWQ2NjQzXkEyXkFqcGc@._V1_FMjpg_UY2100_.jpg', // Placeholder for upcoming
    ...
    [
        ...
        'runtime_minutes' => 120,
        'rating' => 'G',
        'poster_path' => 'https://m.media-amazon.com/images/M/MV5BMjZiZTAwMzctMDA3OS00ZDQ1LWE0YTktMzk1MTcwZTU3ZDFjXkEyXkFqcGc@._V1_FMjpg_UX729_.jpg', // Placeholder
        ...
        // 4. Seed Showtimes (Linked to Cinema 1 and Velocity Strike)
        DB::table('showtimes')->insert([
            [
                'movie_id' => 1, // Velocity Strike
                'hall_id' => 1,  // Cinema 1
                'show_date' => Carbon::today()->toDateString(),
                'show_time' => '13:30:00',
                'price' => 350.00,
                'total_capacity' => 120,
                'created_at' => now(),
